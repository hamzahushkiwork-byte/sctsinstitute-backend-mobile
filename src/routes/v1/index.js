...
import publicYoutubeVideoRoutes from '../public/youtubeVideo.routes.js';
...
router.use('/youtube-videos', publicYoutubeVideoRoutes); // Public active youtube videos endpoint
